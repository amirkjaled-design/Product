...
import { type APIKey, IdPOAuthAccessToken, type M2MToken } from '@clerk/backend/src/api';
import { MachineTokenVerificationError, TokenVerificationError } from '@clerk/backend/src/errors';
...
import type { MachineTokenType } from '@clerk/backend/src/tokens/tokenTypes';
/**
 * @interface
 */
