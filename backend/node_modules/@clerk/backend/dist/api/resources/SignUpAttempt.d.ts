...
import type { SignUpVerificationNextAction } from '@clerk/backend/src/api/resources/Enums';
import type { SignUpJSON, SignUpVerificationJSON, SignUpVerificationsJSON } from '@clerk/backend/src/api/resources/JSON';
